            ...
            <div class="z-depth-1 grey lighten-4 row"
                ...
                <form class="col s12" method="post" id="registro-admin">
                    ...
                    <div class='row'>
                        ...
                        <div class='input-field col s12 l6 m6'>
                            <!--Definicion del tipo de campo a crear-->
                            <input class='validate' type='text' name='usuario_admin' id='usuario_admin' />
                        ...
                        <div class='input-field col s12 l6 m6'>
                            <!--Definicion del tipo de campo a crear-->
                            <input class='validate' type='password' name='contra_admin' id='contra_admin' />
                    ...
                    <div class='row'>
                        ...
                        <div class='input-field col s12 l6 m6'>
                            <!--Definicion del tipo de campo a crear-->
                            <input class='validate' type='text' name='telefono_admin' id='telefono_admin' />
                        ...
                        <div class='input-field col s12 l6 m6'>
                            <!--Definicion del tipo de campo a crear-->
                            <input class='validate' type='email' name='correo_admin' id='correo_admin' />
                    ...
                    <div class="row">
                        ...
                        <div class='input-field col s12 l12 m12'>
                            <!--Definicion del tipo de campo a crear-->
                            <input class='validate' type='text' name='direccion_admin' id='direccion_admin' />
